...
const crmData = {
  ...
  earningGraphData: [
    {name: 'Overdue', value: 18, color: '#E53E3E', colorName: red[7]},
    {name: 'Completed', value: 55, color: '#38A169', colorName: green[6]},
    {name: 'In Progress', value: 49, color: '#4299E1', colorName: blue[5]},
    {
      name: 'Not Started',
      value: 20,
      color: '#CBD5E0',
