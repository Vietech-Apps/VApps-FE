...
import {createNewCard} from 'redux/actions/Projects/cardActions';
...
export default function Column({column, board, tasks, index}) {
  ...
  const submitHandler = (value) => {
    ...
    dispatch(
      createNewActivity({
        text: `${user.name} added ${text} to ${column.name}`,
        boardId: column.boardId,
      }),
    );
    setCardTitle('');
                      ...
                      {showDelete && (
                        <IconButton
                          ...
                          onClick={() => {
                            ...
                            const text = `${user.name} deleted list ${column.name}`;
                            dispatch(
                              createNewActivity({
                                text,
                                boardId: column.boardId,
                    ...
                    (provided) => (
                      <div ref={provided.innerRef} {...provided.droppableProps}>
                        <div className={classes.scroll}>
                          ...
                          {addCardFlag && (
                            <AddCard
                              isModalVisible={addCardFlag}
                              handleCancel={closeButtonHandler}
                              list={column}
                              board={board}
                              cards={tasks}
