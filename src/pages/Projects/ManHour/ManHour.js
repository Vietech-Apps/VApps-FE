...
const Main = () => {
  ...
  const titleForm = `Man Hour`;
  const listPath = `scrum/manhour/list`;
  const createPath = `scrum/manhour/create`;
  const updatePath = `scrum/manhour/update`;
  ...
  const getList2 = async () => {
    try {
      const response = await jwtAxios.get(`scrum/manhour/tickets`);
  ...
  console.log("first1", list1, list2);
