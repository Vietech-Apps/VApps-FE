...
import { Avatar, Drawer, Input, Layout, Select } from "antd";
...
export const StyledHeaderSearchMinibar = styled(Select)`
  position: relative;
  max-width: 140px;
  min-height: 28px;
  margin-left: auto;
...
export const StyledHeaderSelectHorFixed = styled(Select)`
  position: relative;
  max-width: 140px;
  min-height: 28px;
  margin-left: auto;
