...
const defaultTitle = "Vapps | VieTech (Pvt) Ltd";
const defaultDescription =
  "Empower your business with us - streamline your operations, improve efficiency, and drive growth";
const defaultImage =
  "https://firebasestorage.googleapis.com/v0/b/crema-demo.appspot.com/o/logo512.png?alt=media";
const defaultTwitter = "meta";
const defaultSep = " | ";
  ...
  const getMetaTags = (
    {
      ...
      updated,
      category = "VieTech Solutions",
      tags = "Empower your business with us - streamline your operations, improve efficiency, and drive growth",
    },
    pathname
  ) => {
