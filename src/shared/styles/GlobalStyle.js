...
button.ant-btn,button.ant-btn-default,button.ant-btn-primary{
  display: inline-flex;
    align-items: center;
...
button.ant-btn.ant-btn-sm{
  ...
  .ant-table-wrapper .ant-table table thead tr .ant-table-cell{
    height:48px;
    border-top:1px solid #f0f0f0;
  }
  .ant-form-item-label > label, .ant-table-wrapper .ant-table table thead tr .ant-table-cell{
    font-weight:500;
  }
  .ant-btn-text{
     &:hover,
  ...
  .ant-btn-default {
    ...
    &:focus {
      ...
      color:${({ theme }) => darken(0.09, theme.palette.primary.main)} ;
    }
  }
  .ant-btn-primary {
    ...
    &:hover,
    &:focus {
      background: ${({ theme }) => darken(0.08, theme.palette.primary.main)} ;
      border-color: ${({ theme }) => darken(0.08, theme.palette.primary.main)} ;
        color:#f6f6f6;
    }
  }
